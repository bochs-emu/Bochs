...
#endif
  BXRS_HEX_PARAM_FIELD(vmexec_ctrls, posted_intr_notification_vector, BX_CPU_THIS_PTR vmcs.posted_intr_notification_vector);
  BXRS_HEX_PARAM_FIELD(vmexec_ctrls, pid_addr, BX_CPU_THIS_PTR vmcs.pid_addr);
#if BX_SUPPORT_VMX >= 2
