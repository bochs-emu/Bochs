...
void BX_CPP_AttrRegparmN(1) BX_CPU_C::VCVTSD2SH_VshWsdR(bxInstruction_c *i)
{
  ...
  op1.xmm16u(0) = float64_to_float16(op2, status);
...
void BX_CPP_AttrRegparmN(1) BX_CPU_C::VCVTSS2SH_VshWssR(bxInstruction_c *i)
{
  ...
  float_status_t status = mxcsr_to_softfloat_status_word(MXCSR);
  softfloat_status_word_rc_override(status, i);
  op1.xmm16u(0) = float32_to_float16(op2, status);
  check_exceptionsSSE(get_exception_flags(status));
...
void BX_CPP_AttrRegparmN(1) BX_CPU_C::VCVTSH2SD_VsdWshR(bxInstruction_c *i)
{
  ...
  float_status_t status = mxcsr_to_softfloat_status_word(MXCSR);
  softfloat_status_word_rc_override(status, i);
  op1.xmm64u(0) = float16_to_float64(op2, status);
  check_exceptionsSSE(get_exception_flags(status));
...
void BX_CPP_AttrRegparmN(1) BX_CPU_C::VCVTSH2SS_VssWshR(bxInstruction_c *i)
{
  ...
  float_status_t status = mxcsr_to_softfloat_status_word(MXCSR);
  softfloat_status_word_rc_override(status, i);
  op1.xmm32u(0) = float16_to_float32(op2, status);
  check_exceptionsSSE(get_exception_flags(status));
...
void BX_CPP_AttrRegparmN(1) BX_CPU_C::VCVTSH2SI_GdWshR(bxInstruction_c *i)
{
  ...
  float_status_t status = mxcsr_to_softfloat_status_word(MXCSR);
  softfloat_status_word_rc_override(status, i);
  Bit32s result = float16_to_int32(op, status);
  check_exceptionsSSE(get_exception_flags(status));
...
void BX_CPP_AttrRegparmN(1) BX_CPU_C::VCVTSH2SI_GqWshR(bxInstruction_c *i)
{
  ...
  float_status_t status = mxcsr_to_softfloat_status_word(MXCSR);
  softfloat_status_word_rc_override(status, i);
  Bit64s result = float16_to_int64(op, status);
  check_exceptionsSSE(get_exception_flags(status));
...
void BX_CPP_AttrRegparmN(1) BX_CPU_C::VCVTSH2USI_GdWshR(bxInstruction_c *i)
{
  ...
  float_status_t status = mxcsr_to_softfloat_status_word(MXCSR);
  softfloat_status_word_rc_override(status, i);
  Bit32u result = float16_to_uint32(op, status);
  check_exceptionsSSE(get_exception_flags(status));
...
void BX_CPP_AttrRegparmN(1) BX_CPU_C::VCVTSH2USI_GqWshR(bxInstruction_c *i)
{
  ...
  float_status_t status = mxcsr_to_softfloat_status_word(MXCSR);
  softfloat_status_word_rc_override(status, i);
  Bit64u result = float16_to_uint64(op, status);
  check_exceptionsSSE(get_exception_flags(status));
...
void BX_CPP_AttrRegparmN(1) BX_CPU_C::VCVTTSH2SI_GdWshR(bxInstruction_c *i)
{
  ...
  float_status_t status = mxcsr_to_softfloat_status_word(MXCSR);
  softfloat_status_word_rc_override(status, i);
  Bit32s result = float16_to_int32_round_to_zero(op, status);
  check_exceptionsSSE(get_exception_flags(status));
...
void BX_CPP_AttrRegparmN(1) BX_CPU_C::VCVTTSH2SI_GqWshR(bxInstruction_c *i)
{
  ...
  float_status_t status = mxcsr_to_softfloat_status_word(MXCSR);
  softfloat_status_word_rc_override(status, i);
  Bit64s result = float16_to_int64_round_to_zero(op, status);
  check_exceptionsSSE(get_exception_flags(status));
...
void BX_CPP_AttrRegparmN(1) BX_CPU_C::VCVTTSH2USI_GdWshR(bxInstruction_c *i)
{
  ...
  float_status_t status = mxcsr_to_softfloat_status_word(MXCSR);
  softfloat_status_word_rc_override(status, i);
  Bit32u result = float16_to_uint32_round_to_zero(op, status);
  check_exceptionsSSE(get_exception_flags(status));
...
void BX_CPP_AttrRegparmN(1) BX_CPU_C::VCVTTSH2USI_GqWshR(bxInstruction_c *i)
{
  ...
  float_status_t status = mxcsr_to_softfloat_status_word(MXCSR);
  softfloat_status_word_rc_override(status, i);
  Bit64u result = float16_to_uint64_round_to_zero(op, status);
  check_exceptionsSSE(get_exception_flags(status));
...
void BX_CPP_AttrRegparmN(1) BX_CPU_C::VCVTSI2SH_VshEdR(bxInstruction_c *i)
{
  ...
  float_status_t status = mxcsr_to_softfloat_status_word(MXCSR);
  softfloat_status_word_rc_override(status, i);
  op1.xmm16u(0) = int32_to_float16(BX_READ_32BIT_REG(i->src2()), status);
  check_exceptionsSSE(get_exception_flags(status));
...
void BX_CPP_AttrRegparmN(1) BX_CPU_C::VCVTSI2SH_VshEqR(bxInstruction_c *i)
{
  ...
  float_status_t status = mxcsr_to_softfloat_status_word(MXCSR);
  softfloat_status_word_rc_override(status, i);
  op1.xmm16u(0) = int64_to_float16(BX_READ_64BIT_REG(i->src2()), status);
  check_exceptionsSSE(get_exception_flags(status));
...
void BX_CPP_AttrRegparmN(1) BX_CPU_C::VCVTUSI2SH_VshEdR(bxInstruction_c *i)
{
  ...
  float_status_t status = mxcsr_to_softfloat_status_word(MXCSR);
  softfloat_status_word_rc_override(status, i);
  op1.xmm16u(0) = uint32_to_float16(BX_READ_32BIT_REG(i->src2()), status);
  check_exceptionsSSE(get_exception_flags(status));
...
void BX_CPP_AttrRegparmN(1) BX_CPU_C::VCVTUSI2SH_VshEqR(bxInstruction_c *i)
{
  ...
  float_status_t status = mxcsr_to_softfloat_status_word(MXCSR);
  softfloat_status_word_rc_override(status, i);
  op1.xmm16u(0) = uint64_to_float16(BX_READ_64BIT_REG(i->src2()), status);
  check_exceptionsSSE(get_exception_flags(status));
...
AVX512_CVT64_TO_16(VCVTPD2PH_VphWpdR, float64_to_float16)
AVX512_CVT64_TO_16(VCVTQQ2PH_VphWdqR, int64_to_float16)
AVX512_CVT64_TO_16(VCVTUQQ2PH_VphWdqR, uint64_to_float16)
...
AVX512_CVT64_TO_16_MASK(VCVTPD2PH_MASK_VphWpdR, float64_to_float16)
AVX512_CVT64_TO_16_MASK(VCVTQQ2PH_MASK_VphWdqR, int64_to_float16)
AVX512_CVT64_TO_16_MASK(VCVTUQQ2PH_MASK_VphWdqR, uint64_to_float16)
...
AVX512_CVT32_TO_16(VCVTPS2PHX_VphWpsR, float32_to_float16)
AVX512_CVT32_TO_16(VCVTDQ2PH_VphWdqR, int32_to_float16)
AVX512_CVT32_TO_16(VCVTUDQ2PH_VphWdqR, uint32_to_float16)
...
AVX512_CVT32_TO_16_MASK(VCVTPS2PHX_MASK_VphWpsR, float32_to_float16)
AVX512_CVT32_TO_16_MASK(VCVTDQ2PH_MASK_VphWdqR, int32_to_float16)
AVX512_CVT32_TO_16_MASK(VCVTUDQ2PH_MASK_VphWdqR, uint32_to_float16)
...
AVX512_CVT16_TO_32(VCVTPH2PSX_VpsWphR, float16_to_float32)
AVX512_CVT16_TO_32(VCVTPH2DQ_VdqWphR, float16_to_int32)
AVX512_CVT16_TO_32(VCVTTPH2DQ_VdqWphR, float16_to_int32_round_to_zero)
AVX512_CVT16_TO_32(VCVTPH2UDQ_VdqWphR, float16_to_uint32)
AVX512_CVT16_TO_32(VCVTTPH2UDQ_VdqWphR, float16_to_uint32_round_to_zero)
...
AVX512_CVT16_TO_32_MASK(VCVTPH2PSX_MASK_VpsWphR, float16_to_float32)
AVX512_CVT16_TO_32_MASK(VCVTPH2DQ_MASK_VdqWphR, float16_to_int32)
AVX512_CVT16_TO_32_MASK(VCVTTPH2DQ_MASK_VdqWphR, float16_to_int32_round_to_zero)
AVX512_CVT16_TO_32_MASK(VCVTPH2UDQ_MASK_VdqWphR, float16_to_uint32)
AVX512_CVT16_TO_32_MASK(VCVTTPH2UDQ_MASK_VdqWphR, float16_to_uint32_round_to_zero)
...
AVX512_CVT16_TO_64(VCVTPH2PD_VpdWphR, float16_to_float64)
AVX512_CVT16_TO_64(VCVTPH2QQ_VdqWphR, float16_to_int64)
AVX512_CVT16_TO_64(VCVTTPH2QQ_VdqWphR, float16_to_int64_round_to_zero)
AVX512_CVT16_TO_64(VCVTPH2UQQ_VdqWphR, float16_to_uint64)
AVX512_CVT16_TO_64(VCVTTPH2UQQ_VdqWphR, float16_to_uint64_round_to_zero)
...
AVX512_CVT16_TO_64_MASK(VCVTPH2PD_MASK_VpdWphR, float16_to_float64)
AVX512_CVT16_TO_64_MASK(VCVTPH2QQ_MASK_VdqWphR, float16_to_int64)
AVX512_CVT16_TO_64_MASK(VCVTTPH2QQ_MASK_VdqWphR, float16_to_int64_round_to_zero)
AVX512_CVT16_TO_64_MASK(VCVTPH2UQQ_MASK_VdqWphR, float16_to_uint64)
AVX512_CVT16_TO_64_MASK(VCVTTPH2UQQ_MASK_VdqWphR, float16_to_uint64_round_to_zero)
