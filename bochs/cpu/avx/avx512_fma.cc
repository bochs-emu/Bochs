...
EVEX_FMA_SCALAR_SINGLE(VFMADDSH_MASK_VphHshWshR, float16_fmadd)
EVEX_FMA_SCALAR_SINGLE(VFMSUBSH_MASK_VphHshWshR, float16_fmsub)
EVEX_FMA_SCALAR_SINGLE(VFNMADDSH_MASK_VphHshWshR, float16_fnmadd)
EVEX_FMA_SCALAR_SINGLE(VFNMSUBSH_MASK_VphHshWshR, float16_fnmsub)
