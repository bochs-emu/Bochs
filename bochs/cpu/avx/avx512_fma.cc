...
EVEX_FMA_SCALAR_HALF_PRECISION(VFMADDSH_MASK_VphHshWshR, float16_fmadd)
EVEX_FMA_SCALAR_HALF_PRECISION(VFMSUBSH_MASK_VphHshWshR, float16_fmsub)
EVEX_FMA_SCALAR_HALF_PRECISION(VFNMADDSH_MASK_VphHshWshR, float16_fnmadd)
EVEX_FMA_SCALAR_HALF_PRECISION(VFNMSUBSH_MASK_VphHshWshR, float16_fnmsub)
