...
AVX2_FMA_SCALAR_HALF_PRECISION(VFMADDSH_VphHshWshR, float16_fmadd)
AVX2_FMA_SCALAR_HALF_PRECISION(VFMSUBSH_VphHshWshR, float16_fmsub)
AVX2_FMA_SCALAR_HALF_PRECISION(VFNMADDSH_VphHshWshR, float16_fnmadd)
AVX2_FMA_SCALAR_HALF_PRECISION(VFNMSUBSH_VphHshWshR, float16_fnmsub)
