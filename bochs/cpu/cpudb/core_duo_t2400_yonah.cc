...
core_duo_t2400_yonah_t::core_duo_t2400_yonah_t(BX_CPU_C *cpu): bx_cpuid_t(cpu)
{
  ...
  if (BX_SUPPORT_X86_64)
    BX_PANIC(("x86-64 should be disabled for Core Duo (Yonah) configuration"));
}
...
// leaf 0x00000003 //
void core_duo_t2400_yonah_t::get_std_cpuid_leaf_3(cpuid_function_t *leaf) const
{
...
// leaf 0x00000009 //
void core_duo_t2400_yonah_t::get_std_cpuid_leaf_9(cpuid_function_t *leaf) const
{
