...
static const BxOpcodeInfo_t BxOpcode3ByteTable0f38[256*2] = {
  ...
  /* 1F /r */ { 0, BX_IA_ERROR },
  /* 1F /m */ { 0, BX_IA_ERROR },
  /* 20 /r */ { BxPrefixSSE66, BX_IA_PMOVSXBW_VdqWq },
  /* 20 /m */ { BxPrefixSSE66, BX_IA_PMOVSXBW_VdqWq },
  /* 21 /r */ { BxPrefixSSE66, BX_IA_PMOVSXBD_VdqWd },
  /* 21 /m */ { BxPrefixSSE66, BX_IA_PMOVSXBD_VdqWd },
  /* 22 /r */ { BxPrefixSSE66, BX_IA_PMOVSXBQ_VdqWw },
  /* 22 /m */ { BxPrefixSSE66, BX_IA_PMOVSXBQ_VdqWw },
  /* 23 /r */ { BxPrefixSSE66, BX_IA_PMOVSXWD_VdqWq },
  /* 23 /m */ { BxPrefixSSE66, BX_IA_PMOVSXWD_VdqWq },
  /* 24 /r */ { BxPrefixSSE66, BX_IA_PMOVSXWQ_VdqWd },
  /* 24 /m */ { BxPrefixSSE66, BX_IA_PMOVSXWQ_VdqWd },
  /* 25 /r */ { BxPrefixSSE66, BX_IA_PMOVSXDQ_VdqWq },
  /* 25 /m */ { BxPrefixSSE66, BX_IA_PMOVSXDQ_VdqWq },
  /* 26 /r */ { 0, BX_IA_ERROR },
  /* 26 /m */ { 0, BX_IA_ERROR },
  /* 27 /r */ { 0, BX_IA_ERROR },
  /* 27 /m */ { 0, BX_IA_ERROR },
  ...
  /* 2F /r */ { 0, BX_IA_ERROR },
  /* 2F /m */ { 0, BX_IA_ERROR },
  /* 30 /r */ { BxPrefixSSE66, BX_IA_PMOVZXBW_VdqWq },
  /* 30 /m */ { BxPrefixSSE66, BX_IA_PMOVZXBW_VdqWq },
  /* 31 /r */ { BxPrefixSSE66, BX_IA_PMOVZXBD_VdqWd },
  /* 31 /m */ { BxPrefixSSE66, BX_IA_PMOVZXBD_VdqWd },
  /* 32 /r */ { BxPrefixSSE66, BX_IA_PMOVZXBQ_VdqWw },
  /* 32 /m */ { BxPrefixSSE66, BX_IA_PMOVZXBQ_VdqWw },
  /* 33 /r */ { BxPrefixSSE66, BX_IA_PMOVZXWD_VdqWq },
  /* 33 /m */ { BxPrefixSSE66, BX_IA_PMOVZXWD_VdqWq },
  /* 34 /r */ { BxPrefixSSE66, BX_IA_PMOVZXWQ_VdqWd },
  /* 34 /m */ { BxPrefixSSE66, BX_IA_PMOVZXWQ_VdqWd },
  /* 35 /r */ { BxPrefixSSE66, BX_IA_PMOVZXDQ_VdqWq },
