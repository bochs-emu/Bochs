...
static const BxOpcodeInfo_t BxOpcodeGroupAVX_0f38f5_VEX0[3] = {
  /* 66 */ { 0, BX_IA_ERROR },
  /* F3 */ { 0, BX_IA_PEXT_GdBdEd },
  /* F2 */ { 0, BX_IA_PDEP_GdBdEd }
};

static const BxOpcodeInfo_t BxOpcodeGroupAVX_0f38f5_VEX1[3] = {
  /* 66 */ { 0, BX_IA_ERROR },
  /* F3 */ { 0, BX_IA_PEXT_GqBqEq },
  /* F2 */ { 0, BX_IA_PDEP_GqBqEq }
};

static const BxOpcodeInfo_t BxOpcodeInfoAVX_VexW_0f38f5[2] = {
  /* 0 */ { BxPrefixSSE, BX_IA_BZHI_GdBdEd, BxOpcodeGroupAVX_0f38f5_VEX0 },
  /* 1 */ { BxPrefixSSE, BX_IA_BZHI_GqBqEq, BxOpcodeGroupAVX_0f38f5_VEX1 }
};
...
static const BxOpcodeInfo_t BxOpcodeTableAVX[256*3*2] = {
  ...
  /* 2F /0 */ { BxPrefixSSE, BX_IA_VCOMISS_VssWss, BxOpcodeGroupAVX_0f2f },
  /* 2F /1 */ { BxPrefixSSE, BX_IA_VCOMISS_VssWss, BxOpcodeGroupAVX_0f2f },
  /* 30 /0 */ { 0, BX_IA_ERROR },
  /* 30 /1 */ { 0, BX_IA_ERROR },
  /* 31 /0 */ { 0, BX_IA_ERROR },
  /* 31 /1 */ { 0, BX_IA_ERROR },
  ...
  /* 40 /1 */ { 0, BX_IA_ERROR },
  /* 41 /0 */ { 0, BX_IA_ERROR },
  /* 41 /1 */ { BxPrefixSSE | BxVexW0, BX_IA_KANDW_KGwKHwKEw, BxOpcodeGroupSSE_ERR },
  /* 42 /0 */ { 0, BX_IA_ERROR },
  /* 42 /1 */ { BxPrefixSSE | BxVexW0, BX_IA_KANDNW_KGwKHwKEw, BxOpcodeGroupSSE_ERR },
  /* 43 /0 */ { 0, BX_IA_ERROR },
  /* 43 /1 */ { 0, BX_IA_ERROR },
  /* 44 /0 */ { BxPrefixSSE | BxVexW0, BX_IA_KNOTW_KGwKEw, BxOpcodeGroupSSE_ERR },
  /* 44 /1 */ { 0, BX_IA_ERROR },
  /* 45 /0 */ { 0, BX_IA_ERROR },
  /* 45 /1 */ { BxPrefixSSE | BxVexW0, BX_IA_KORW_KGwKHwKEw, BxOpcodeGroupSSE_ERR },
  /* 46 /0 */ { 0, BX_IA_ERROR },
  /* 46 /1 */ { BxPrefixSSE | BxVexW0, BX_IA_KXNORW_KGwKHwKEw, BxOpcodeGroupSSE_ERR },
  /* 47 /0 */ { 0, BX_IA_ERROR },
  /* 47 /1 */ { BxPrefixSSE | BxVexW0, BX_IA_KXORW_KGwKHwKEw, BxOpcodeGroupSSE_ERR },
  /* 48 /0 */ { 0, BX_IA_ERROR },
  /* 48 /1 */ { 0, BX_IA_ERROR },
  /* 49 /0 */ { 0, BX_IA_ERROR },
  /* 49 /1 */ { 0, BX_IA_ERROR },
  ...
  /* 4A /1 */ { 0, BX_IA_ERROR },
  /* 4B /0 */ { 0, BX_IA_ERROR },
  /* 4B /1 */ { BxPrefixSSE66 | BxVexW0, BX_IA_KUNPCKBW_KGwKHbKEb },
  /* 4C /0 */ { 0, BX_IA_ERROR },
  /* 4C /1 */ { 0, BX_IA_ERROR },
  /* 4D /0 */ { 0, BX_IA_ERROR },
  /* 4D /1 */ { 0, BX_IA_ERROR },
  ...
  /* 4F /0 */ { 0, BX_IA_ERROR },
  /* 4F /1 */ { 0, BX_IA_ERROR },
  /* 50 /0 */ { BxPrefixSSE, BX_IA_VMOVMSKPS_GdUps, BxOpcodeGroupAVX_0f50R },
  /* 50 /1 */ { BxPrefixSSE, BX_IA_VMOVMSKPS_GdUps, BxOpcodeGroupAVX_0f50R },
  ...
  /* 8F /0 */ { 0, BX_IA_ERROR },
  /* 8F /1 */ { 0, BX_IA_ERROR },
  /* 90 /0 */ { BxPrefixSSE | BxVexW0, BX_IA_KMOVW_KGwKEw, BxOpcodeGroupSSE_ERR },
  /* 90 /1 */ { 0, BX_IA_ERROR },
  /* 91 /0 */ { BxPrefixSSE | BxVexW0, BX_IA_KMOVW_KEwKGw, BxOpcodeGroupSSE_ERR },
  /* 91 /1 */ { 0, BX_IA_ERROR },
  /* 92 /0 */ { BxPrefixSSE | BxVexW0, BX_IA_KMOVW_KGwEw, BxOpcodeGroupSSE_ERR },
  /* 92 /1 */ { 0, BX_IA_ERROR },
  /* 93 /0 */ { BxPrefixSSE | BxVexW0, BX_IA_KMOVW_GdKEw, BxOpcodeGroupSSE_ERR },
  /* 93 /1 */ { 0, BX_IA_ERROR },
  /* 94 /0 */ { 0, BX_IA_ERROR },
  /* 94 /1 */ { 0, BX_IA_ERROR },
  /* 95 /0 */ { 0, BX_IA_ERROR },
  ...
  /* 97 /0 */ { 0, BX_IA_ERROR },
  /* 97 /1 */ { 0, BX_IA_ERROR },
  /* 98 /0 */ { BxPrefixSSE | BxVexW0, BX_IA_KORTESTW_KGwKEw, BxOpcodeGroupSSE_ERR },
  /* 98 /1 */ { 0, BX_IA_ERROR },
  /* 99 /0 */ { 0, BX_IA_ERROR },
  /* 99 /1 */ { 0, BX_IA_ERROR },
  /* 9A /0 */ { 0, BX_IA_ERROR },
  ...
  /* 2F /0 */ { 0, BX_IA_ERROR },
  /* 2F /1 */ { 0, BX_IA_ERROR },
  /* 30 /0 */ { BxPrefixSSE66 | BxVexW1 | BxImmediate_Ib, BX_IA_KSHIFTRW_KGwKEwIb },
  /* 30 /1 */ { 0, BX_IA_ERROR },
  /* 31 /0 */ { 0, BX_IA_ERROR },
  /* 31 /1 */ { 0, BX_IA_ERROR },
  /* 32 /0 */ { BxPrefixSSE66 | BxVexW1 | BxImmediate_Ib, BX_IA_KSHIFTLW_KGwKEwIb },
  /* 32 /1 */ { 0, BX_IA_ERROR },
  /* 33 /0 */ { 0, BX_IA_ERROR },
  /* 33 /1 */ { 0, BX_IA_ERROR },
  /* 34 /0 */ { 0, BX_IA_ERROR },
