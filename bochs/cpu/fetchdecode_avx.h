...
static const BxOpcodeInfo_t BxOpcodeTableAVX[256*3*2] = {
  ...
  /* 4A /1 */ { 0, BX_IA_ERROR },
  /* 4B /0 */ { 0, BX_IA_ERROR },
  /* 4B /1 */ { BxPrefixSSE66 | BxVexW0, BX_IA_KUNPCKBW_KGwKHwKEw },
  /* 4C /0 */ { 0, BX_IA_ERROR },
  /* 4C /1 */ { 0, BX_IA_ERROR },
  /* 4D /0 */ { 0, BX_IA_ERROR },
  /* 4D /1 */ { 0, BX_IA_ERROR },
  ...
  /* 2F /0 */ { 0, BX_IA_ERROR },
  /* 2F /1 */ { 0, BX_IA_ERROR },
  /* 30 /0 */ { BxPrefixSSE66 | BxVexW1 | BxImmediate_Ib, BX_IA_KSHIFTLW_KGwKEw },
  /* 30 /1 */ { 0, BX_IA_ERROR },
  /* 31 /0 */ { 0, BX_IA_ERROR },
  /* 31 /1 */ { 0, BX_IA_ERROR },
  /* 32 /0 */ { BxPrefixSSE66 | BxVexW1 | BxImmediate_Ib, BX_IA_KSHIFTLW_KGwKEw },
  /* 32 /1 */ { 0, BX_IA_ERROR },
  /* 33 /0 */ { 0, BX_IA_ERROR },
  /* 33 /1 */ { 0, BX_IA_ERROR },
  /* 34 /0 */ { 0, BX_IA_ERROR },
