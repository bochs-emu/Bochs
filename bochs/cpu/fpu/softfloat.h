...
float16 float16_muladd(float16, float16, float16, int flags, float_status_t &status);
...
BX_CPP_INLINE float16 float16_fmadd(float16 a, float16 b, float16 c, float_status_t &status)
{
  return float16_muladd(a, b, c, 0, status);
}

BX_CPP_INLINE float16 float16_fmsub(float16 a, float16 b, float16 c, float_status_t &status)
{
  return float16_muladd(a, b, c, float_muladd_negate_c, status);
}

BX_CPP_INLINE float16 float16_fnmadd(float16 a, float16 b, float16 c, float_status_t &status)
{
  return float16_muladd(a, b, c, float_muladd_negate_product, status);
}

BX_CPP_INLINE float16 float16_fnmsub(float16 a, float16 b, float16 c, float_status_t &status)
{
  return float16_muladd(a, b, c, float_muladd_negate_result, status);
}
