...
//fprintf(stderr, "TASKING: ENTER\n");
  ...
  if (tss_descriptor->p==0) {
    BX_CPU_THIS_PTR info("task_switch: TSS.p == 0\n");
  ...
  if (tss_selector->ti ||
    ...
    BX_CPU_THIS_PTR panic("task_switch(): TR not valid\n");
...
BX_CPU_THIS_PTR ldtr.cache.u.ldt.limit = 0;
  ...
  if (ldt_selector.ti) {
    ...
    BX_CPU_THIS_PTR info("task_switch: bad LDT selector TI=1\n");
...
// ??? is LDT loaded in v8086 mode
  if ( (raw_ldt_selector & 0xfffc) != 0 ) {
    ...
    if (!good) {
      BX_CPU_THIS_PTR info("task_switch: bad LDT fetch\n");
      exception_no = BX_TS_EXCEPTION;
      error_code   = raw_ldt_selector & 0xfffc;
      goto post_exception;
      }
    ...
    if (ldt_descriptor.valid==0 ||
      ...
      BX_CPU_THIS_PTR info("task_switch: bad LDT segment\n");
      exception_no = BX_TS_EXCEPTION;
      error_code   = raw_ldt_selector & 0xfffc;
      goto post_exception;
      }
  ...
  if ( (raw_cs_selector & 0xfffc) != 0 ) {
    ...
    if (!good) {
      BX_CPU_THIS_PTR info("task_switch: bad CS fetch\n");
      exception_no = BX_TS_EXCEPTION;
    ...
    if (cs_descriptor.valid==0 || cs_descriptor.segment==0 ||
      ...
      BX_CPU_THIS_PTR panic("task_switch: CS not valid executable seg\n");
      exception_no = BX_TS_EXCEPTION;
      error_code   = raw_cs_selector & 0xfffc;
      goto post_exception;
      }
    // if non-conforming then DPL must equal selector RPL else #TS(CS)
      ...
      BX_CPU_THIS_PTR info("task_switch: non-conforming: CS.dpl!=CS.RPL\n");
      exception_no = BX_TS_EXCEPTION;
      error_code   = raw_cs_selector & 0xfffc;
      goto post_exception;
      }
    // if conforming then DPL must be <= selector RPL else #TS(CS)
        ...
        cs_descriptor.dpl>cs_selector.rpl) {
      BX_CPU_THIS_PTR info("task_switch: conforming: CS.dpl>RPL\n");
      exception_no = BX_TS_EXCEPTION;
      error_code   = raw_cs_selector & 0xfffc;
      goto post_exception;
      }
    // Code segment is present in memory, else #NP(new code segment)
      ...
      BX_CPU_THIS_PTR panic("task_switch: CS.p==0\n");
    ...
    BX_CPU_THIS_PTR panic("task_switch: CS NULL\n");
    exception_no = BX_TS_EXCEPTION;
    error_code   = raw_cs_selector & 0xfffc;
    goto post_exception;
    }
  ...
  if ( (raw_ss_selector & 0xfffc) != 0 ) {
    ...
    if (!good) {
      BX_CPU_THIS_PTR info("task_switch: bad SS fetch\n");
      exception_no = BX_TS_EXCEPTION;
    ...
    if (ss_descriptor.valid==0 ||
      ...
      BX_CPU_THIS_PTR info("task_switch: SS not valid\n");
      exception_no = BX_TS_EXCEPTION;
      error_code   = raw_ss_selector & 0xfffc;
      goto post_exception;
      }
    ...
    //
      ...
      BX_CPU_THIS_PTR panic("task_switch: SS not present\n");
    ...
    // Stack segment DPL matches CS.RPL, else #TS(new stack segment)
      ...
      BX_CPU_THIS_PTR panic("task_switch: SS.rpl != CS.RPL\n");
      exception_no = BX_TS_EXCEPTION;
      error_code   = raw_ss_selector & 0xfffc;
      goto post_exception;
      }
    ...
    // Stack segment DPL matches selector RPL, else #TS(new stack segment)
      ...
      BX_CPU_THIS_PTR panic("task_switch: SS.dpl != SS.rpl\n");
      exception_no = BX_TS_EXCEPTION;
      error_code   = raw_ss_selector & 0xfffc;
      goto post_exception;
      }
    ...
    BX_CPU_THIS_PTR panic("task_switch: SS NULL\n");
    exception_no = BX_TS_EXCEPTION;
    error_code   = raw_ss_selector & 0xfffc;
    goto post_exception;
    }
  ...
  if ( (raw_ds_selector & 0xfffc) != 0 ) {
    ...
    if (!good) {
      BX_CPU_THIS_PTR info("task_switch: bad DS fetch\n");
      exception_no = BX_TS_EXCEPTION;
    ...
    if (ds_descriptor.valid==0 || ds_descriptor.segment==0 ||
      ...
      BX_CPU_THIS_PTR panic("task_switch: DS not valid\n");
      exception_no = BX_TS_EXCEPTION;
      error_code   = raw_ds_selector & 0xfffc;
      goto post_exception;
      }
    // if data or non-conforming code
      ...
      BX_CPU_THIS_PTR panic("task_switch: DS.dpl not valid\n");
      exception_no = BX_TS_EXCEPTION;
      error_code   = raw_ds_selector & 0xfffc;
      goto post_exception;
      }
    else if (ds_descriptor.p==0) {
      BX_CPU_THIS_PTR panic("task_switch: DS.p==0\n");
      exception_no = BX_NP_EXCEPTION;
      error_code   = raw_ds_selector & 0xfffc;
      goto post_exception;
      }
  ...
  if ( (raw_es_selector & 0xfffc) != 0 ) {
    ...
    if (!good) {
      BX_CPU_THIS_PTR info("task_switch: bad ES fetch\n");
      exception_no = BX_TS_EXCEPTION;
    ...
    if (es_descriptor.valid==0 || es_descriptor.segment==0 ||
      ...
      BX_CPU_THIS_PTR panic("task_switch: ES not valid\n");
      exception_no = BX_TS_EXCEPTION;
      error_code   = raw_es_selector & 0xfffc;
      goto post_exception;
      }
    // if data or non-conforming code
      ...
      BX_CPU_THIS_PTR panic("task_switch: ES.dpl not valid\n");
      exception_no = BX_TS_EXCEPTION;
      error_code   = raw_es_selector & 0xfffc;
      goto post_exception;
      }
    else if (es_descriptor.p==0) {
      BX_CPU_THIS_PTR panic("task_switch: ES.p==0\n");
      exception_no = BX_NP_EXCEPTION;
      error_code   = raw_es_selector & 0xfffc;
      goto post_exception;
      }
  ...
  if ( (raw_fs_selector & 0xfffc) != 0 ) { // not NULL
    ...
    if (!good) {
      BX_CPU_THIS_PTR info("task_switch: bad FS fetch\n");
      exception_no = BX_TS_EXCEPTION;
    ...
    if (fs_descriptor.valid==0 || fs_descriptor.segment==0 ||
      ...
      BX_CPU_THIS_PTR panic("task_switch: FS not valid\n");
      exception_no = BX_TS_EXCEPTION;
      error_code   = raw_fs_selector & 0xfffc;
      goto post_exception;
      }
    // if data or non-conforming code
      ...
      BX_CPU_THIS_PTR panic("task_switch: FS.dpl not valid\n");
      exception_no = BX_TS_EXCEPTION;
      error_code   = raw_fs_selector & 0xfffc;
      goto post_exception;
      }
    else if (fs_descriptor.p==0) {
      BX_CPU_THIS_PTR panic("task_switch: FS.p==0\n");
      exception_no = BX_NP_EXCEPTION;
      error_code   = raw_fs_selector & 0xfffc;
      goto post_exception;
      }
  ...
  if ( (raw_gs_selector & 0xfffc) != 0 ) {
    ...
    if (!good) {
      BX_CPU_THIS_PTR info("task_switch: bad GS fetch\n");
      exception_no = BX_TS_EXCEPTION;
    ...
    if (gs_descriptor.valid==0 || gs_descriptor.segment==0 ||
      ...
      BX_CPU_THIS_PTR panic("task_switch: GS not valid\n");
      exception_no = BX_TS_EXCEPTION;
      error_code   = raw_gs_selector & 0xfffc;
      goto post_exception;
      }
    // if data or non-conforming code
      ...
      BX_CPU_THIS_PTR panic("task_switch: GS.dpl not valid\n");
      exception_no = BX_TS_EXCEPTION;
      error_code   = raw_gs_selector & 0xfffc;
      goto post_exception;
      }
    else if (gs_descriptor.p==0) {
      BX_CPU_THIS_PTR panic("task_switch: GS.p==0\n");
  ...
  if ((tss_descriptor->type>=9) && (trap_word & 0x0001)) {
    ...
    BX_CPU_THIS_PTR info("task_switch: T bit set in new TSS.\n");
    }
...
post_exception:
  BX_CPU_THIS_PTR debug_trap = 0;
  BX_CPU_THIS_PTR inhibit_mask = 0;
  BX_CPU_THIS_PTR info("task switch: posting exception %u after commit point\n",
    exception_no);
...
BX_CPU_C::get_SS_ESP_from_TSS(unsigned pl, Bit16u *ss, Bit32u *esp)
{
  if (BX_CPU_THIS_PTR tr.cache.valid==0)
    BX_CPU_THIS_PTR panic("get_SS_ESP_from_TSS: TR.cache invalid\n");
  ...
  if (BX_CPU_THIS_PTR tr.cache.type==9) {
    ...
    *esp = temp16; // truncate
    ...
    BX_CPU_THIS_PTR panic("get_SS_ESP_from_TSS: TR is bogus type (%u)\n",
                 ...
                 Bit32u dword1, Bit32u dword2)
{
  ...
  BX_CPU_THIS_PTR info("task_switch(): not complete\n");
}
#endif
