...
static const BxOpcodeInfo_t BxOpcodeGroupEVEX_0f387c[2] = {
  /* VexW=0 */ { BxPrefixSSE66, BX_IA_V512_VPBROADCASTD_VdqEd },
  /* VexW=1 */ { BxPrefixSSE66, BX_IA_V512_VPBROADCASTQ_VdqEq }
};

static const BxOpcodeInfo_t BxOpcodeGroupEVEX_0f387c_Mask[2] = {
  /* VexW=0 */ { BxPrefixSSE66, BX_IA_V512_VPBROADCASTD_VdqEd_Kmask },
  /* VexW=1 */ { BxPrefixSSE66, BX_IA_V512_VPBROADCASTQ_VdqEq_Kmask }
};
...
static const BxOpcodeInfo_t BxOpcodeTableEVEX[256*3*2] = {
  ...
  /* 13 k0 */ { 0, BX_IA_ERROR },
  /* 13    */ { 0, BX_IA_ERROR },
  /* 14 k0 */ { BxAliasVexW | BxPrefixSSE66, BX_IA_V512_VPRORVD_VdqHdqWdq },
  /* 14    */ { BxAliasVexW | BxPrefixSSE66, BX_IA_V512_VPRORVD_VdqHdqWdq_Kmask },
  /* 15 k0 */ { BxAliasVexW | BxPrefixSSE66, BX_IA_V512_VPROLVD_VdqHdqWdq },
  /* 15    */ { BxAliasVexW | BxPrefixSSE66, BX_IA_V512_VPROLVD_VdqHdqWdq_Kmask },
  /* 16 k0 */ { 0, BX_IA_ERROR },
  /* 16    */ { 0, BX_IA_ERROR },
  /* 17 k0 */ { 0, BX_IA_ERROR },
  /* 17    */ { 0, BX_IA_ERROR },
  ...
  /* 7B k0 */ { 0, BX_IA_ERROR },
  /* 7B    */ { 0, BX_IA_ERROR },
  /* 7C k0 */ { BxSplitVexW64, BX_IA_ERROR, BxOpcodeGroupEVEX_0f387c },
  /* 7C    */ { BxSplitVexW64, BX_IA_ERROR, BxOpcodeGroupEVEX_0f387c_Mask },
  /* 7D k0 */ { 0, BX_IA_ERROR },
  /* 7D    */ { 0, BX_IA_ERROR },
  /* 7E k0 */ { 0, BX_IA_ERROR },
  /* 7E    */ { 0, BX_IA_ERROR },
