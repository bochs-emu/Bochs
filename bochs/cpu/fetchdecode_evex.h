...
static const BxOpcodeInfo_t BxOpcodeTableEVEX[256*3*2] = {
  ...
  /* 70    */ { BxVexW0 | BxPrefixSSE66 | BxImmediate_Ib, BX_IA_V512_VPSHUFD_VdqWdqIb_Kmask },
  /* 71 k0 */ { 0, BX_IA_ERROR },
  /* 71    */ { 0, BX_IA_ERROR },
  ...
  /* 78    */ { BxPrefixSSE | BxAliasVexW, BX_IA_V512_VCVTTPS2UDQ_VdqWps_Kmask, BxOpcodeGroupSSE_ERR },
  ...
  /* 10 k0 */ { 0, BX_IA_ERROR },
  /* 10    */ { 0, BX_IA_ERROR },
  /* 11 k0 */ { BxVexW0 | BxPrefixSSEF3, BX_IA_V512_VPMOVUSDB_WdqVdq },
  /* 11    */ { BxVexW0 | BxPrefixSSEF3, BX_IA_V512_VPMOVUSDB_WdqVdq_Kmask },
  /* 12 k0 */ { BxVexW0 | BxPrefixSSEF3, BX_IA_V512_VPMOVUSQB_WdqVdq },
  /* 12    */ { BxVexW0 | BxPrefixSSEF3, BX_IA_V512_VPMOVUSQB_WdqVdq_Kmask },
  /* 13 k0 */ { BxVexW0 | BxPrefixSSEF3, BX_IA_V512_VPMOVUSDW_WdqVdq },
  /* 13    */ { BxVexW0 | BxPrefixSSEF3, BX_IA_V512_VPMOVUSDW_WdqVdq_Kmask },
  ...
  /* 2A k0 */ { BxVexW0 | BxPrefixSSE66, BX_IA_V512_VMOVNTDQA_VdqMdq },
  /* 2A    */ { 0, BX_IA_ERROR }, // #UD
  /* 2B k0 */ { 0, BX_IA_ERROR },
  /* 2B    */ { 0, BX_IA_ERROR },
  /* 2C k0 */ { 0, BX_IA_ERROR },
