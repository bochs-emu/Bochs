...
void BX_CPP_AttrRegparmN(2) BX_CPU_C::stack_write_byte(bx_address offset, Bit8u data)
{
  ...
  if (BX_CPU_THIS_PTR espHostPtr) {
    ...
    BX_NOTIFY_LIN_MEMORY_ACCESS(get_laddr(BX_SEG_REG_SS, offset), pAddr, 1, BX_MEMTYPE_INVALID, BX_WRITE, (Bit8u*) &data);
...
#endif
    BX_NOTIFY_LIN_MEMORY_ACCESS(get_laddr(BX_SEG_REG_SS, offset), pAddr, 2, BX_MEMTYPE_INVALID, BX_WRITE, (Bit8u*) &data);
...
#endif
    BX_NOTIFY_LIN_MEMORY_ACCESS(get_laddr(BX_SEG_REG_SS, offset), pAddr, 4, BX_MEMTYPE_INVALID, BX_WRITE, (Bit8u*) &data);
...
#endif
    BX_NOTIFY_LIN_MEMORY_ACCESS(get_laddr(BX_SEG_REG_SS, offset), pAddr, 8, BX_MEMTYPE_INVALID, BX_WRITE, (Bit8u*) &data);
...
Bit8u BX_CPP_AttrRegparmN(1) BX_CPU_C::stack_read_byte(bx_address offset)
{
  ...
  if (BX_CPU_THIS_PTR espHostPtr) {
    ...
    BX_NOTIFY_LIN_MEMORY_ACCESS(get_laddr(BX_SEG_REG_SS, offset),
        (BX_CPU_THIS_PTR pAddrStackPage + espBiased), 1, BX_MEMTYPE_INVALID, BX_READ, (Bit8u*) &data);
    return data;
  }
  else {
...
Bit16u BX_CPP_AttrRegparmN(1) BX_CPU_C::stack_read_word(bx_address offset)
{
  ...
  if (BX_CPU_THIS_PTR espHostPtr) {
    ...
    BX_NOTIFY_LIN_MEMORY_ACCESS(get_laddr(BX_SEG_REG_SS, offset),
        (BX_CPU_THIS_PTR pAddrStackPage + espBiased), 2, BX_MEMTYPE_INVALID, BX_READ, (Bit8u*) &data);
    return data;
  }
  else {
...
Bit32u BX_CPP_AttrRegparmN(1) BX_CPU_C::stack_read_dword(bx_address offset)
{
  ...
  if (BX_CPU_THIS_PTR espHostPtr) {
    ...
    BX_NOTIFY_LIN_MEMORY_ACCESS(get_laddr(BX_SEG_REG_SS, offset),
        (BX_CPU_THIS_PTR pAddrStackPage + espBiased), 4, BX_MEMTYPE_INVALID, BX_READ, (Bit8u*) &data);
    return data;
  }
  else {
...
Bit64u BX_CPP_AttrRegparmN(1) BX_CPU_C::stack_read_qword(bx_address offset)
{
  ...
  if (BX_CPU_THIS_PTR espHostPtr) {
    ...
    BX_NOTIFY_LIN_MEMORY_ACCESS(get_laddr(BX_SEG_REG_SS, offset),
        (BX_CPU_THIS_PTR pAddrStackPage + espBiased), 8, BX_MEMTYPE_INVALID, BX_READ, (Bit8u*) &data);
    return data;
  }
  else {
