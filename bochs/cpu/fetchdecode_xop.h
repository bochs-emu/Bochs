...
static const BxOpcodeInfo_t BxOpcodeTableXOP[256*3*2] = {
  ...
  /* A3 /0 */ { BxAliasVexW | BxImmediate_Ib4, BX_IA_VPPERM_VdqHdqVIbWdq },
  /* A4 /0 */ { 0, BX_IA_ERROR },
  /* A5 /0 */ { 0, BX_IA_ERROR },
  ...
  /* 86 /0 */ { 0, BX_IA_ERROR },
  /* 87 /0 */ { 0, BX_IA_ERROR },
  /* 88 /0 */ { BxAliasVexW, BX_IA_VPSHAB_VdqHdqWdq },
  /* 89 /0 */ { BxAliasVexW, BX_IA_VPSHAW_VdqHdqWdq },
  /* 8A /0 */ { BxAliasVexW, BX_IA_VPSHAD_VdqHdqWdq },
  /* 8B /0 */ { BxAliasVexW, BX_IA_VPSHAQ_VdqHdqWdq },
  /* 8C /0 */ { 0, BX_IA_ERROR },
  /* 8D /0 */ { 0, BX_IA_ERROR },
  /* 8E /0 */ { 0, BX_IA_ERROR },
  /* 8F /0 */ { 0, BX_IA_ERROR },
  /* 90 /0 */ { BxAliasVexW, BX_IA_VPROTB_VdqHdqWdq },
  /* 91 /0 */ { BxAliasVexW, BX_IA_VPROTW_VdqHdqWdq },
  /* 92 /0 */ { BxAliasVexW, BX_IA_VPROTD_VdqHdqWdq },
  /* 93 /0 */ { BxAliasVexW, BX_IA_VPROTQ_VdqHdqWdq },
  /* 94 /0 */ { BxAliasVexW, BX_IA_VPSHLB_VdqHdqWdq },
  /* 95 /0 */ { BxAliasVexW, BX_IA_VPSHLW_VdqHdqWdq },
  /* 96 /0 */ { BxAliasVexW, BX_IA_VPSHLD_VdqHdqWdq },
  /* 97 /0 */ { BxAliasVexW, BX_IA_VPSHLQ_VdqHdqWdq },
  /* 98 /0 */ { 0, BX_IA_ERROR },
  /* 99 /0 */ { 0, BX_IA_ERROR },
  /* 9A /0 */ { 0, BX_IA_ERROR },
  /* 9B /0 */ { 0, BX_IA_ERROR },
  ...
  /* A0 /1 */ { 0, BX_IA_ERROR },
  /* A1 /1 */ { 0, BX_IA_ERROR },
  /* A2 /1 */ { BxAliasVexW | BxImmediate_Ib4, BX_IA_VPCMOV_VdqHdqVIbWdq },
  /* A3 /1 */ { 0, BX_IA_ERROR },
  /* A4 /1 */ { 0, BX_IA_ERROR },
  /* A5 /1 */ { 0, BX_IA_ERROR },
  /* A6 /1 */ { 0, BX_IA_ERROR },
