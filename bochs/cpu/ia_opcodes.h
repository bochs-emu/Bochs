...
bx_define_opcode(BX_IA_V128_VMOVSD_VsdHpdWsd, NULL, &BX_CPU_C::VMOVSD_VsdHpdWsdR, BX_ISA_AVX, OP_Vsd, OP_Wsd, BX_SRC_VVV, OP_NONE, BX_PREPARE_AVX)
bx_define_opcode(BX_IA_V128_VMOVSS_VssHpsWss, NULL, &BX_CPU_C::VMOVSS_VssHpsWssR, BX_ISA_AVX, OP_Vss, OP_Wss, BX_SRC_VVV, OP_NONE, BX_PREPARE_AVX)
bx_define_opcode(BX_IA_V128_VMOVSD_WsdHpdVsd, NULL, &BX_CPU_C::VMOVSD_VsdHpdWsdR, BX_ISA_AVX, OP_Wsd, OP_Vsd, BX_SRC_VVV, OP_NONE, BX_PREPARE_AVX)
bx_define_opcode(BX_IA_V128_VMOVSS_WssHpsVss, NULL, &BX_CPU_C::VMOVSS_VssHpsWssR, BX_ISA_AVX, OP_Wss, OP_Vss, BX_SRC_VVV, OP_NONE, BX_PREPARE_AVX)
...
bx_define_opcode(BX_IA_V512_VMOVSD_VsdHpdWsd, NULL, &BX_CPU_C::VMOVSD_VsdHpdWsdR, BX_ISA_AVX512, OP_Vsd, OP_Wsd, BX_SRC_VVV, OP_NONE, BX_PREPARE_EVEX)
bx_define_opcode(BX_IA_V512_VMOVSS_VssHpsWss, NULL, &BX_CPU_C::VMOVSS_VssHpsWssR, BX_ISA_AVX512, OP_Vss, OP_Wss, BX_SRC_VVV, OP_NONE, BX_PREPARE_EVEX)
bx_define_opcode(BX_IA_V512_VMOVSD_WsdHpdVsd, NULL, &BX_CPU_C::VMOVSD_VsdHpdWsdR, BX_ISA_AVX512, OP_Wsd, OP_Vsd, BX_SRC_VVV, OP_NONE, BX_PREPARE_EVEX)
bx_define_opcode(BX_IA_V512_VMOVSS_WssHpsVss, NULL, &BX_CPU_C::VMOVSS_VssHpsWssR, BX_ISA_AVX512, OP_Wss, OP_Vss, BX_SRC_VVV, OP_NONE, BX_PREPARE_EVEX)
...
bx_define_opcode(BX_IA_V512_VMOVSD_VsdHpdWsd_Kmask, NULL, &BX_CPU_C::VMOVSD_MASK_VsdHpdWsdR, BX_ISA_AVX512, OP_Vsd, OP_Wsd, BX_SRC_VVV, OP_NONE, BX_PREPARE_EVEX)
bx_define_opcode(BX_IA_V512_VMOVSS_VssHpsWss_Kmask, NULL, &BX_CPU_C::VMOVSS_MASK_VssHpsWssR, BX_ISA_AVX512, OP_Vss, OP_Wss, BX_SRC_VVV, OP_NONE, BX_PREPARE_EVEX)
bx_define_opcode(BX_IA_V512_VMOVSD_WsdHpdVsd_Kmask, NULL, &BX_CPU_C::VMOVSD_MASK_VsdHpdWsdR, BX_ISA_AVX512, OP_Wsd, OP_Vsd, BX_SRC_VVV, OP_NONE, BX_PREPARE_EVEX)
bx_define_opcode(BX_IA_V512_VMOVSS_WssHpsVss_Kmask, NULL, &BX_CPU_C::VMOVSS_MASK_VssHpsWssR, BX_ISA_AVX512, OP_Wss, OP_Vss, BX_SRC_VVV, OP_NONE, BX_PREPARE_EVEX)
