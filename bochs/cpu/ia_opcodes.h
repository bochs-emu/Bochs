...
bx_define_opcode(BX_IA_RCL_EbR, &BX_CPU_C::RCL_EbR, NULL, 0)
bx_define_opcode(BX_IA_RCL_EbM, &BX_CPU_C::RCL_EbM, NULL, 0)
bx_define_opcode(BX_IA_RCL_EwR, &BX_CPU_C::RCL_EwR, NULL, 0)
bx_define_opcode(BX_IA_RCL_EwM, &BX_CPU_C::RCL_EwM, NULL, 0)
bx_define_opcode(BX_IA_RCR_EbR, &BX_CPU_C::RCR_EbR, NULL, 0)
bx_define_opcode(BX_IA_RCR_EbM, &BX_CPU_C::RCR_EbM, NULL, 0)
bx_define_opcode(BX_IA_RCR_EwR, &BX_CPU_C::RCR_EwR, NULL, 0)
bx_define_opcode(BX_IA_RCR_EwM, &BX_CPU_C::RCR_EwM, NULL, 0)
...
bx_define_opcode(BX_IA_ROL_EbR, &BX_CPU_C::ROL_EbR, NULL, 0)
bx_define_opcode(BX_IA_ROL_EbM, &BX_CPU_C::ROL_EbM, NULL, 0)
bx_define_opcode(BX_IA_ROL_EwR, &BX_CPU_C::ROL_EwR, NULL, 0)
bx_define_opcode(BX_IA_ROL_EwM, &BX_CPU_C::ROL_EwM, NULL, 0)
bx_define_opcode(BX_IA_ROR_EbR, &BX_CPU_C::ROR_EbR, NULL, 0)
bx_define_opcode(BX_IA_ROR_EbM, &BX_CPU_C::ROR_EbM, NULL, 0)
bx_define_opcode(BX_IA_ROR_EwR, &BX_CPU_C::ROR_EwR, NULL, 0)
bx_define_opcode(BX_IA_ROR_EwM, &BX_CPU_C::ROR_EwM, NULL, 0)
...
bx_define_opcode(BX_IA_SAR_EbR, &BX_CPU_C::SAR_EbR, NULL, 0)
bx_define_opcode(BX_IA_SAR_EbM, &BX_CPU_C::SAR_EbM, NULL, 0)
bx_define_opcode(BX_IA_SAR_EwR, &BX_CPU_C::SAR_EwR, NULL, 0)
bx_define_opcode(BX_IA_SAR_EwM, &BX_CPU_C::SAR_EwM, NULL, 0)
...
bx_define_opcode(BX_IA_SHL_EbR, &BX_CPU_C::SHL_EbR, NULL, 0)
bx_define_opcode(BX_IA_SHL_EbM, &BX_CPU_C::SHL_EbM, NULL, 0)
bx_define_opcode(BX_IA_SHL_EwR, &BX_CPU_C::SHL_EwR, NULL, 0)
bx_define_opcode(BX_IA_SHL_EwM, &BX_CPU_C::SHL_EwM, NULL, 0)
...
bx_define_opcode(BX_IA_SHR_EbR, &BX_CPU_C::SHR_EbR, NULL, 0)
bx_define_opcode(BX_IA_SHR_EbM, &BX_CPU_C::SHR_EbM, NULL, 0)
bx_define_opcode(BX_IA_SHR_EwR, &BX_CPU_C::SHR_EwR, NULL, 0)
bx_define_opcode(BX_IA_SHR_EwM, &BX_CPU_C::SHR_EwM, NULL, 0)
