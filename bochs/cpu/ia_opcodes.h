...
bx_define_opcode(BX_IA_V512_VCVTUQQ2PD_VpdWdq, &BX_CPU_C::LOAD_BROADCAST_VectorQ, &BX_CPU_C::VCVTUQQ2PD_VpdWdqR, BX_ISA_AVX512_DQ, OP_Vpd, OP_mVpd, OP_NONE, OP_NONE, BX_PREPARE_EVEX)
...
bx_define_opcode(BX_IA_V512_VCVTUQQ2PD_VpdWdq_Kmask, &BX_CPU_C::LOAD_BROADCAST_MASK_VectorQ, &BX_CPU_C::VCVTUQQ2PD_MASK_VpdWdqR, BX_ISA_AVX512_DQ, OP_Vpd, OP_mVpd, OP_NONE, OP_NONE, BX_PREPARE_EVEX)
