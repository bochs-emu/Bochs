...
#if BX_USE_R128_SMF
#  define BX_R128_SMF  static
#  define BX_R128_THIS theSvga->
#  define BX_R128_THIS_PTR theSvga
#else
#  define BX_R128_SMF
#  define BX_R128_THIS this->
#  define BX_R128_THIS_PTR this
#endif // BX_USE_R128_SMF

// 0x3b4,0x3d4
#define VGA_CRTC_MAX 0x18
#define R128_CRTC_MAX 0x9F

// ATI Rage 128 register aperture size (8KB = 0x2000)
#define R128_REG_APER_SIZE 0x2000

#define BX_ROP_PATTERN 0x01

class bx_r128_c : public bx_vgacore_c
{
public:
  bx_r128_c();
  virtual ~bx_r128_c();
...
private:
...
#endif
  BX_R128_SMF void   svga_init_members();
  BX_R128_SMF void   bitblt_init();
  BX_R128_SMF void   execute_bitblt();

  BX_R128_SMF void draw_hardware_cursor(unsigned, unsigned, bx_svga_tileinfo_t *);

  // 0x3b4-0x3b5,0x3d4-0x3d5
  BX_R128_SMF Bit8u svga_read_crtc(Bit32u address, unsigned index);
  BX_R128_SMF void  svga_write_crtc(Bit32u address, unsigned index, Bit8u value);

  BX_R128_SMF void set_irq_level(bool level);
  BX_R128_SMF Bit32u get_crt_intr();

  BX_R128_SMF Bit8u register_read8(Bit32u address);
  BX_R128_SMF void  register_write8(Bit32u address, Bit8u value);
  BX_R128_SMF Bit32u register_read32(Bit32u address);
  BX_R128_SMF void  register_write32(Bit32u address, Bit32u value);

  BX_R128_SMF Bit8u vram_read8(Bit32u address);
  BX_R128_SMF Bit16u vram_read16(Bit32u address);
  BX_R128_SMF Bit32u vram_read32(Bit32u address);
  BX_R128_SMF void vram_write8(Bit32u address, Bit8u value);
  BX_R128_SMF void vram_write16(Bit32u address, Bit16u value);
  BX_R128_SMF void vram_write32(Bit32u address, Bit32u value);

  struct {
    Bit8u index;
    Bit8u reg[R128_CRTC_MAX+1];
  ...
  Bit32u regs[R128_REG_APER_SIZE / 4];
  ...
  BX_R128_SMF void svga_init_pcihandlers(void);

  void vertical_timer();

  BX_R128_SMF bool r128_mem_read_handler(bx_phy_address addr, unsigned len, void *data, void *param);
  BX_R128_SMF bool r128_mem_write_handler(bx_phy_address addr, unsigned len, void *data, void *param);
};
