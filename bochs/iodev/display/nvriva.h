...
#define NVRIVA_CRTC_MAX 0x57

#define NVRIVA_CHANNEL_COUNT 16
...
struct nv_channel
{
  ...
  // Font F/G
  Bit32u gdi_dma_fonts;
  Bit32u gdi_font_offset;
  Bit32u gdi_font_pitch;
  Bit32u gdi_font_clip_yx0;
  Bit32u gdi_font_clip_yx1;
  Bit32u gdi_font_color;
  Bit32u gdi_font_g_xy;
};
...
private:
  ...
  BX_NVRIVA_SMF Bit64u vram_read64(Bit32u address);
  ...
  BX_NVRIVA_SMF Bit64u physical_read64(Bit32u address);
  ...
  BX_NVRIVA_SMF Bit64u dma_read64(Bit32u object, Bit32u address);
  ...
  BX_NVRIVA_SMF void update_color_bytes_s2d(nv_channel* ch);
  BX_NVRIVA_SMF void update_color_bytes_ifc(nv_channel* ch);
  BX_NVRIVA_SMF void update_color_bytes(Bit32u s2d_color_fmt, Bit32u color_fmt, Bit32u* color_bytes);

  BX_NVRIVA_SMF void execute_clip(nv_channel* ch, Bit32u method, Bit32u param);
  BX_NVRIVA_SMF void execute_m2mf(nv_channel* ch, Bit32u subc, Bit32u method, Bit32u param);
  BX_NVRIVA_SMF void execute_rop(nv_channel* ch, Bit32u method, Bit32u param);
  BX_NVRIVA_SMF void execute_patt(nv_channel* ch, Bit32u method, Bit32u param);
  BX_NVRIVA_SMF void execute_chroma(nv_channel* ch, Bit32u method, Bit32u param);
  BX_NVRIVA_SMF void execute_rect(nv_channel* ch, Bit32u method, Bit32u param);
  BX_NVRIVA_SMF void execute_imageblit(nv_channel* ch, Bit32u method, Bit32u param);
  BX_NVRIVA_SMF void execute_ifc(nv_channel* ch, Bit32u method, Bit32u param);
  BX_NVRIVA_SMF void execute_surf2d(nv_channel* ch, Bit32u method, Bit32u param);
  BX_NVRIVA_SMF void execute_beta(nv_channel* ch, Bit32u method, Bit32u param);
  BX_NVRIVA_SMF void execute_gdi(nv_channel* ch, Bit32u cls, Bit32u method, Bit32u param);
  BX_NVRIVA_SMF void execute_sifm(nv_channel* ch, Bit32u method, Bit32u param);
  BX_NVRIVA_SMF void execute_sifc(nv_channel* ch, Bit32u method, Bit32u param);
  BX_NVRIVA_SMF void update_color_bytes_sifc(nv_channel* ch);

  BX_NVRIVA_SMF Bit32u get_pixel(Bit32u obj, Bit32u ofs, Bit32u x, Bit32u cb);
  BX_NVRIVA_SMF void put_pixel(nv_channel* ch, Bit32u ofs, Bit32u x, Bit32u value);
  BX_NVRIVA_SMF void pixel_operation(nv_channel* ch, Bit32u op,
    Bit32u* dstcolor, const Bit32u* srccolor, Bit32u cb, Bit32u px, Bit32u py);

  BX_NVRIVA_SMF void rect(nv_channel* ch);
  BX_NVRIVA_SMF void gdi_fillrect(nv_channel* ch, bool clipped);
  BX_NVRIVA_SMF void gdi_blit(nv_channel* ch, Bit32u type);
  BX_NVRIVA_SMF void gdi_font_render(nv_channel* ch, Bit16s dx, Bit16s dy, Bit32u glyph_index);
  BX_NVRIVA_SMF void ifc(nv_channel* ch, Bit32u word);
  BX_NVRIVA_SMF void copyarea(nv_channel* ch);
  BX_NVRIVA_SMF void sifm(nv_channel* ch);
  BX_NVRIVA_SMF void sifc(nv_channel* ch);
  BX_NVRIVA_SMF void m2mf(nv_channel* ch);
  ...
  nv_channel chs[NVRIVA_CHANNEL_COUNT];
