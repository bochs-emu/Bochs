...
static BxDisasmOpcodeInfo_t BxDisasmOpcodeInfoFP[512] = { 
  ...
  /* DB E6 */  { INVALID },
  /* DB E7 */  { INVALID },
  /* DB E8 */  { "fucomi",    0, ST0, STj, XX },
  /* DB E9 */  { "fucomi",    0, ST0, STj, XX },
  /* DB EA */  { "fucomi",    0, ST0, STj, XX },
  /* DB EB */  { "fucomi",    0, ST0, STj, XX },
  /* DB EC */  { "fucomi",    0, ST0, STj, XX },
  /* DB ED */  { "fucomi",    0, ST0, STj, XX },
  /* DB EE */  { "fucomi",    0, ST0, STj, XX },
  /* DB EF */  { "fucomi",    0, ST0, STj, XX },
  /* DB F0 */  { "fcomi",     0, ST0, STj, XX },
  /* DB F1 */  { "fcomi",     0, ST0, STj, XX },
  /* DB F2 */  { "fcomi",     0, ST0, STj, XX },
  /* DB F3 */  { "fcomi",     0, ST0, STj, XX },
  /* DB F4 */  { "fcomi",     0, ST0, STj, XX },
  /* DB F5 */  { "fcomi",     0, ST0, STj, XX },
  /* DB F6 */  { "fcomi",     0, ST0, STj, XX },
  /* DB F7 */  { "fcomi",     0, ST0, STj, XX },
  /* DB F8 */  { INVALID },
  /* DB F9 */  { INVALID },
  /* DB FA */  { INVALID },
  /* DB FB */  { INVALID },
